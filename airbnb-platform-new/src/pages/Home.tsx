...
/**
 * Static category strip rendered above the hero. These are pure visual chips
 * that filter by accommodation `type` — kept inline because there is no
 * categories table in the BDD and they were always frontend-only labels.
 */
interface Category {
  id: string;
  name: string;
...
const CATEGORIES: Category[] = [
  { id: 'all', name: 'All' },
  { id: 'apartment', name: 'Apartments', type: 'apartment' },
  { id: 'house', name: 'Houses', type: 'house' },
  { id: 'villa', name: 'Villas', type: 'villa' },
  { id: 'condo', name: 'Condos', type: 'condo' },
  { id: 'cabin', name: 'Cabins', type: 'cabin' },
  { id: 'guesthouse', name: 'Guesthouses', type: 'guesthouse' },
  { id: 'studio', name: 'Studios', type: 'studio' },
  { id: 'private_room', name: 'Private rooms', type: 'private_room' },
];
...
export const Home = () => {
  ...
  const handleSearch = (searchData: {
    ...
    params.set(
      'guests',
      (searchData.guests.adults + searchData.guests.children).toString()
    );
  ...
  if (loading) {
    return <LoadingState label="Loading stays..." />;
  }
  ...
  const all = accommodations ?? [];
  const featuredAccommodations = all.slice(0, 8);
  const highRated = all.filter(
    (acc) => acc.rating.average !== null && acc.rating.average >= 4.9
  );
  const topRated =
    highRated.length > 0 ? highRated.slice(0, 4) : all.slice(0, 4);
    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-[600px] bg-gradient-to-r from-primary/90 to-primary">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl">
            Discover unique homes and experiences around the world. From cozy
            cabins to luxury villas, find your next adventure.
          </p>
              ...
              {CATEGORIES.map((category) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    if (category.type) {
                      navigate(`/listings?type=${category.type}`);
                    } else {
                      navigate('/listings');
                    }
                  }}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {featuredAccommodations.length === 0 ? (
          <p className="text-gray-600">No accommodations available yet.</p>
        ) : (
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Properties with 4.9+ ratings from our guests
                </p>
              </div>
              <button
                onClick={() => navigate('/listings')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Your payments are protected and your personal information is
              always secure.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              All properties are verified and reviewed by our community of
              travelers.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/90 text-lg max-w-xl">
                Share your space and earn extra income. Join our community of
                hosts and start welcoming guests from around the world.
              </p>
            </div>
            <button
